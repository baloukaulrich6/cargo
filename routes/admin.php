    ...
    if (\Illuminate\Support\Facades\Schema::hasTable('translations') && check_module('localization')) {
        Route::group(
            ...
            Route::group(['prefix' => env('PREFIX_ADMIN', 'admin')], function () {
                ...
                Route::middleware('auth')->namespace('Admin')->group(function () {
                    ...
                    // Backup Database
                    Route::get('/backup-database', 'SystemController@getBackupDatabase')->name('backup.database');
                    Route::get('/post/backup-database', 'SystemController@postBackupDatabase')->name('post.backup.database');
        ...
        Route::group(['prefix' => env('PREFIX_ADMIN', 'admin')], function () {
            ...
            Route::middleware('auth')->namespace('Admin')->group(function () {
                ...
                Route::get('/system-update', 'SystemController@getSystemUpdate')->name('system.update');
                Route::post('/post/system-update', 'SystemController@postSystemUpdate')->name('post.system.update');

                // Backup Database
                Route::get('/backup-database', 'SystemController@getBackupDatabase')->name('backup.database');
                Route::get('/backup-database', 'SystemController@postBackupDatabase')->name('post.backup.database');
                // Support
                Route::get('/system-support', 'SupportController@getSystemSupport')->name('system.support');
